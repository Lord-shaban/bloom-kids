...
// .wrangler/tmp/pages-IRnfi0/functionsWorker-0.44871950787468506.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var ALLOWED_STATUSES = ["new", "contacted", "confirmed"];
...
async function onRequestDelete(context) {
  ...
  if (!Number.isInteger(id) || id <= 0) return json({ ok: false, error: "\u0631\u0642\u0645 \u063A\u064A\u0631 \u0635\u0627\u0644\u062D" }, 400);
  try {
    const result = await context.env.DB.prepare(`DELETE FROM registrations WHERE id = ?1`).bind(id).run();
    if (!result.meta.changes) return json({ ok: false, error: "\u0627\u0644\u062A\u0633\u062C\u064A\u0644 \u0645\u0634 \u0645\u0648\u062C\u0648\u062F" }, 404);
    return json({ ok: true });
  } catch {
    return json({ ok: false, error: "\u062D\u0635\u0644\u062A \u0645\u0634\u0643\u0644\u0629\u060C \u062D\u0627\u0648\u0644 \u062A\u0627\u0646\u064A" }, 500);
...
async function onRequestPost(context) {
  ...
  if (!adminPassword) {
    return json2({ ok: false, error: "ADMIN_PASSWORD \u0645\u0634 \u0645\u0636\u0628\u0648\u0637 \u0641\u064A \u0625\u0639\u062F\u0627\u062F\u0627\u062A \u0627\u0644\u0645\u0634\u0631\u0648\u0639" }, 500);
  }
  let body;
  try {
    body = await context.request.json();
  } catch {
    return json2({ ok: false, error: "\u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0635\u0627\u0644\u062D\u0629" }, 400);
  }
  ...
  if (diff !== 0) {
    return json2({ ok: false, error: "\u0643\u0644\u0645\u0629 \u0627\u0644\u0633\u0631 \u063A\u0644\u0637" }, 401);
  }
...
async function onRequestPost2(context) {
  ...
  try {
    ...
    return json3({ ok: false, error: "\u0628\u064A\u0627\u0646\u0627\u062A \u063A\u064A\u0631 \u0635\u0627\u0644\u062D\u0629" }, 400);
  }
  if (body.website) {
  ...
  const notes = clean(body.notes, 1e3);
  if (!parentName || !childName || !childAge) {
    return json3({ ok: false, error: "\u0645\u0646 \u0641\u0636\u0644\u0643 \u0627\u0645\u0644\u0623 \u0643\u0644 \u0627\u0644\u062D\u0642\u0648\u0644 \u0627\u0644\u0645\u0637\u0644\u0648\u0628\u0629" }, 400);
  }
  if (phone.replace(/\D/g, "").length < 10) {
    return json3({ ok: false, error: "\u0631\u0642\u0645 \u0627\u0644\u0647\u0627\u062A\u0641 \u063A\u064A\u0631 \u0635\u062D\u064A\u062D" }, 400);
  }
  try {
    await context.env.DB.prepare(
      `INSERT INTO registrations (parent_name, phone, child_name, child_age, notes)
       VALUES (?1, ?2, ?3, ?4, ?5)`
    ).bind(parentName, phone, childName, childAge, notes).run();
  } catch (err) {
    return json3({ ok: false, error: "\u062D\u0635\u0644\u062A \u0645\u0634\u0643\u0644\u0629 \u0645\u0624\u0642\u062A\u0629\u060C \u062D\u0627\u0648\u0644 \u062A\u0627\u0646\u064A" }, 500);
  }
  return json3({ ok: true });
}
...
__name(json4, "json4");
__name2(json4, "json");
function authorized2(context) {
  const header = context.request.headers.get("Authorization") || "";
  const token = header.replace(/^Bearer\s+/i, "");
  return token && context.env.ADMIN_PASSWORD && token === context.env.ADMIN_PASSWORD;
}
__name(authorized2, "authorized2");
__name2(authorized2, "authorized");
async function onRequestGet(context) {
  if (!authorized2(context)) {
    return json4({ ok: false, error: "\u063A\u064A\u0631 \u0645\u0635\u0631\u062D" }, 401);
  }
  try {
    ...
    return json4({ ok: true, items: results });
  } catch (err) {
    return json4({ ok: false, error: "\u062D\u0635\u0644\u062A \u0645\u0634\u0643\u0644\u0629 \u0641\u064A \u062A\u062D\u0645\u064A\u0644 \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A" }, 500);
  }
}
...
// .wrangler/tmp/bundle-2FCn1c/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-2FCn1c/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.44871950787468506.js.map
